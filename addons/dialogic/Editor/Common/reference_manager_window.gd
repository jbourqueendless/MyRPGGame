...
enum DialogTypes {TEXT, VARIABLE, PORTRAIT, CHARACTER_NAME, TIMELINE_NAME}
...
func add_ref_change(old_name:String, new_name:String, type:DialogTypes, where:=Where.TEXTS_ONLY, character_names:=[],
...
func add_variable_ref_change(old_name:String, new_name:String) -> void:
	add_ref_change(old_name, new_name, DialogTypes.VARIABLE, Where.EVERYWHERE)
...
func add_portrait_ref_change(old_name:String, new_name:String, character_names:PackedStringArray) -> void:
	add_ref_change(old_name, new_name, DialogTypes.PORTRAIT, Where.BY_CHARACTER, character_names)


## Helper for adding character name ref changes
func add_character_name_ref_change(old_name:String, new_name:String) -> void:
	add_ref_change(old_name, new_name, DialogTypes.CHARACTER_NAME, Where.EVERYWHERE)


## Helper for adding timeline name ref changes
func add_timeline_name_ref_change(old_name:String, new_name:String) -> void:
	add_ref_change(old_name, new_name, DialogTypes.TIMELINE_NAME, Where.EVERYWHERE)
